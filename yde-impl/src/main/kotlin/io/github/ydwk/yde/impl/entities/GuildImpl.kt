...
internal class GuildImpl(
    ...
    return withContext(yde.coroutineDispatcher) {
      yde.restApiManager
        ...
        .execute { response ->
          ...
          val member =
            yde.entityInstanceBuilder.buildMember(jsonBody, GetterSnowFlake.of(idAsLong), null)
  ...
  override suspend fun kickMember(userId: Long, reason: String?): RestResult<NoResult> {
    return yde.restAPIMethodGetters.getGuildRestAPIMethods().kickMember(idAsLong, userId, reason)
  }
