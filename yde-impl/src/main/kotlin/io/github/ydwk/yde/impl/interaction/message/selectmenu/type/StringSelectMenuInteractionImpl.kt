...
import io.github.ydwk.yde.interaction.message.selectmenu.interaction.type.StringSelectMenuInteraction
import io.github.ydwk.yde.util.GetterSnowFlake

class StringSelectMenuInteractionImpl(
    override val yde: YDE,
    override val json: JsonNode,
    override val interactionId: GetterSnowFlake,
    override val customId: String,
    override val selectedOptions: List<SelectMenuOption>,
