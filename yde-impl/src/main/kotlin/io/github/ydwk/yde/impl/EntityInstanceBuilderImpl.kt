...
class EntityInstanceBuilderImpl(val yde: YDEImpl) : EntityInstanceBuilder {
  ...
  override fun buildUser(json: JsonNode): User {
    ...
    return UserImpl(
      ...
      json["avatar"].isNull,
      if (json.hasNonNull("bot")) json["bot"].asBoolean() else null,
  ...
  override fun buildGuild(json: JsonNode): Guild {
    ...
    return GuildImpl(
      ...
      if (json.has("afk_channel_id")) GetterSnowFlake.of(json["afk_channel_id"].asLong()) else null,
      json["afk_timeout"].asInt(),
      if (json.has("widget_enabled")) json["widget_enabled"].asBoolean() else null,
      if (json.has("widget_channel_id")) GetterSnowFlake.of(json["widget_channel_id"].asLong())
      else null,
      ...
      if (json.has("application_id")) GetterSnowFlake.of(json["application_id"].asLong()) else null,
      if (json.has("system_channel_id")) GetterSnowFlake.of(json["system_channel_id"].asLong())
      else null,
      ...
      if (json.has("max_video_channel_users")) json["max_video_channel_users"].asInt() else null,
      if (json.has("approximate_member_count")) json["approximate_member_count"].asInt() else null,
  ...
  override fun buildPartialGuild(json: JsonNode): PartialGuild {
    return PartialGuildImpl(
      yde,
      json,
      json["id"].asLong(),
      if (json.has("icon")) json["icon"].asText() else "",
      if (json.has("banner")) json["banner"].asText() else "",
      json["owner"].asBoolean(),
      json["permissions"].asText(),
      json["features"].map { GuildFeature.getValue(it.asText()) }.toSet(),
      if (json.has("approximate_member_count")) json["approximate_member_count"].asInt() else 0,
      if (json.has("approximate_presence_count")) json["approximate_presence_count"].asInt() else 0,
    )
  }
  ...
  override fun buildMessage(json: JsonNode): Message {
    ...
    return MessageImpl(
      ...
      if (json.has("mention_channels")) json["mention_channels"].map { buildMentionedChannel(it) }
      else emptyList(),
      ...
      if (json.has("message_reference")) buildMessageReference(json["message_reference"]) else null,
      if (json.has("flags")) MessageFlag.getValue(json["flags"].asLong()) else null,
      if (json.hasNonNull("referenced_message")) buildMessage(json["referenced_message"]) else null,
  ...
  override fun buildVoiceState(json: JsonNode, backUpGuild: Guild?): VoiceState {
    ...
    return VoiceStateImpl(
      ...
      user,
      if (json.has("member"))
        buildMember(json["member"], GetterSnowFlake.of(json["guild_id"].asLong()), user)
      else null,
  ...
  override suspend fun buildGuildScheduledEvent(json: JsonNode): GuildScheduledEvent {
    ...
    return GuildScheduledEventImpl(
      ...
      json["id"].asLong(),
      guildId,
      if (json.has("channel_id")) yde.getGuildChannelById(json["channel_id"].asLong()) else null,
      if (json.has("creator")) buildUser(json["creator"]) else null,
      if (json.has("description")) json["description"].asText() else null,
      formatZonedDateTime(json["scheduled_start"].asText()),
      if (json.has("scheduled_end_time")) formatZonedDateTime(json["scheduled_end_time"].asText())
      else null,
  ...
  override suspend fun buildInvite(json: JsonNode): Invite {
    return InviteImpl(
      ...
      if (json.has("target_application")) buildApplication(json["target_application"]) else null,
  ...
  override fun buildMember(json: JsonNode, guildId: GetterSnowFlake, backUpUser: User?): Member {
    ...
    return MemberImpl(
      ...
      nickName,
      guildAvatarHash,
      getGuildAvatar(1024, guildAvatarHash, guildId.asLong, user),
      json["roles"].map { GetterSnowFlake.of(it.asLong()) },
  ...
  override fun buildRoleTag(json: JsonNode): RoleTag {
    return RoleTagImpl(
      ...
      if (json.has("integration_id")) GetterSnowFlake.of(json["integration_id"].asLong()) else null,
    )
  }
  ...
  override fun buildGuildForumChannel(json: JsonNode): GuildForumChannel {
    return GuildForumChannelImpl(
      ...
      if (json.has("available_forum_tags")) json["available_forum_tags"].map { buildForumTag(it) }
      else emptyList(),
  ...
  override fun buildGuildMessageChannel(json: JsonNode): GuildMessageChannel {
    return GuildMessageChannelImpl(
      ...
      json["topic"].asText(),
      json["nsfw"].asBoolean(),
      if (json.has("default_auto_archive_duration")) json["default_auto_archive_duration"].asInt()
      else 0,
  ...
  override fun buildGuildTextChannel(json: JsonNode): GuildTextChannel {
    return GuildTextChannelImpl(yde, json, json["id"].asLong(), json["rate_limit_per_user"].asInt())
  }
  ...
  override fun buildEmoji(json: JsonNode): Emoji {
    return EmojiImpl(
      ...
      if (json.has("roles")) json["roles"].map { GetterSnowFlake.of(it.asLong()) } else emptyList(),
      if (json.has("user")) buildUser(json["user"]) else null,
  ...
  override fun buildImage(json: JsonNode): Image {
    return ImageImpl(
      ...
      json,
      @Suppress("DEPRECATION") URL(json["url"].asText()),
      if (json.has("proxy_url")) @Suppress("DEPRECATION") URL(json["proxy_url"].asText()) else null,
      if (json.has("height")) json["height"].asInt() else null,
      if (json.has("width")) json["width"].asInt() else null,
    )
  }
  ...
  override fun buildComponentInteraction(
    ...
    return ComponentInteractionImpl(
      ...
      if (json.has("channel_id"))
        yde
          .getGuildChannelById(json["channel_id"].asLong())
          ?.guildChannelGetter
  ...
  override fun buildComponentInteractionData(json: JsonNode): ComponentInteractionData {
    return ComponentInteractionDataImpl(
      ...
      if (json.has("values")) json["values"].map { buildSelectOptionValue(it) } else emptyList(),
    )
  }

  override fun buildSelectOptionValue(json: JsonNode): ComponentInteractionData.SelectOptionValue {
  ...
  override fun buildSelectMenu(json: JsonNode): SelectMenu {
    return SelectMenuImpl(
      ...
      if (json.has("default_values"))
        json["default_values"].map { buildSelectMenuDefaultValues(it) }
      else null,
      if (json.has("channel_types"))
        json["channel_types"].map { ChannelType.getValue(it.asInt()) }.toSet()
      else null,
    )
  }
  ...
  override fun buildSelectMenuDefaultValues(json: JsonNode): SelectMenuDefaultValues {
    return SelectMenuDefaultValuesImpl(
      yde,
      json,
      SelectMenuDefaultValues.Type.getValue(json["type"].asText()),
    )
  }
  ...
  override fun buildSelectMenuInteraction(
    ...
    val data = json["data"]
    return SelectMenuInteractionImpl(yde, json, interactionId, data["custom_id"].asText(), "", 0, 1)
  }
  ...
  override fun buildUserSelectMenuInteraction(
    ...
    val data = json["data"]
    val selectedUsers =
      if (data.has("resolved") && data["resolved"].has("users"))
        data["resolved"]["users"].map { buildUser(it) }
      else emptyList()
    return UserSelectMenuInteractionImpl(
      yde,
      json,
      interactionId,
      data["custom_id"].asText(),
  ...
  override fun buildStringSelectMenuInteraction(
    ...
    return StringSelectMenuInteractionImpl(
      yde,
      json,
      interactionId,
      data["custom_id"].asText(),
  ...
  override fun buildRoleSelectMenuInteraction(
    ...
    val data = json["data"]
    val selectedRoles =
      if (data.has("resolved") && data["resolved"].has("roles"))
        data["resolved"]["roles"].map { buildRole(it) }
      else emptyList()
    return RoleSelectMenuInteractionImpl(
      yde,
      json,
      interactionId,
      data["custom_id"].asText(),
  ...
  override fun buildMemberSelectMenuInteraction(
    ...
    val data = json["data"]
    val guildId =
      if (json.has("guild_id")) GetterSnowFlake.of(json["guild_id"].asLong())
      else GetterSnowFlake.of(0L)
    val selectedMembers =
      if (data.has("resolved") && data["resolved"].has("members"))
        data["resolved"]["members"].map { buildMember(it, guildId, null) }
      else emptyList()
    return MemberSelectMenuInteractionImpl(
      yde,
      json,
      interactionId,
      data["custom_id"].asText(),
  ...
  override fun buildChannelSelectMenuInteraction(
    ...
    val selectedChannels =
      if (data.has("resolved") && data["resolved"].has("channels"))
        data["resolved"]["channels"].map { buildGuildChannel(it) }
      else emptyList()
    return ChannelSelectMenuInteractionImpl(
      yde,
      json,
      interactionId,
      data["custom_id"].asText(),
  ...
  override fun buildTextInputInteraction(
    ...
    val values =
      if (data.has("components"))
        data["components"].flatMap { row ->
          if (row.has("components"))
            row["components"].mapNotNull { comp ->
              if (comp.has("value")) comp["value"].asText() else null
            }
          else emptyList()
        }
      else emptyList()
    return TextInputInteractionImpl(yde, json, interactionId, data["custom_id"].asText(), values)
  }
  ...
  override fun buildApplicationCommand(
    ...
    return ApplicationCommandImpl(
      ...
      if (json.has("description")) json["description"].asText() else "null",
      if (json.has("nsfw")) json["nsfw"].asBoolean() else false,
      if (json.has("dm_permission")) json["dm_permission"].asBoolean() else false,
  ...
  override fun buildSlashCommand(json: JsonNode, interaction: Interaction?): SlashCommand {
    return SlashCommandImpl(yde, json["data"], interaction ?: buildInteraction(json))
  }
  ...
  override fun buildAutoModerationRule(json: JsonNode): AutoModerationRule {
    ...
    return AutoModerationRuleImpl(
      ...
      if (triggerMetadata.has("allow_list")) triggerMetadata["allow_list"].map { it.asText() }
      else emptyList(),
      if (triggerMetadata.has("mention_total_limit")) triggerMetadata["mention_total_limit"].asInt()
      else null,
