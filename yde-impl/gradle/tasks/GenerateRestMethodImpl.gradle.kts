...
fun generateRestAPIMethodGetters() {
  ...
  val ydeCodeDr = File(ydeApiProject.projectDir, "src/main/kotlin/io/github/ydwk/yde/rest/methods")
    ...
    FileSpec.builder("io.github.ydwk.yde.rest.methods", "RestAPIMethodGetterImpl")
      .addType(
        TypeSpec.classBuilder("RestAPIMethodGetterImpl")
          ...
          .addSuperinterface(ClassName("io.github.ydwk.yde.rest.methods", "RestAPIMethodGetters"))
          .addFunctions(
            interfaceNames.map {
