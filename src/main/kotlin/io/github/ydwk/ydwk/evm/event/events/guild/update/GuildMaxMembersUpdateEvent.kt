...
/**
 * This event is triggered when a guild's max members is updated.
 *
 * @param ydwk The [YDWK] instance.
 * @param entity The [Guild] that was updated.
 * @param oldMaxMembers The old max members.
 * @param newMaxMembers The new max members.
 */
data class GuildMaxMembersUpdateEvent(
