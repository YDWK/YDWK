...
/**
 * This event is triggered when a guild forum channel's default sort order is updated.
 *
 * @param ydwk The [YDWK] instance.
 * @param entity The [GuildForumChannel] that was updated.
 * @param oldDefaultSortOrder The old default sort order.
 * @param newDefaultSortOrder The new default sort order.
 */
