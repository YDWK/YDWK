...
/**
 * This event is triggered when a guild forum channel's nsfw is updated.
 *
 * @param ydwk The [YDWK] instance.
 * @param entity The [GuildForumChannel] that was updated.
 * @param oldNsfw The old nsfw.
 * @param newNsfw The new nsfw.
 */
@ChannelEvent
data class ForumChannelNsfwUpdateEvent(
