 ...
 */ 
package io.github.ydwk.ydwk.eventmanager

import io.github.ydwk.ydwk.eventmanager.backend.ClassWalker
...
import io.github.ydwk.ydwk.eventmanager.backend.update.IEventUpdate
import io.github.ydwk.ydwk.eventmanager.event.Event
...
abstract class ListenerAdapter : IEventListener {
     ...
     */
    open fun onReady(event: io.github.ydwk.ydwk.eventmanager.event.events.gateway.ReadyEvent) {}
    ...
    open fun onDisconnect(
        event: io.github.ydwk.ydwk.eventmanager.event.events.gateway.DisconnectEvent
    ) {}
     ...
     */
    open fun onResume(event: io.github.ydwk.ydwk.eventmanager.event.events.gateway.ResumeEvent) {}
     ...
     */
    open fun onShutDown(
        event: io.github.ydwk.ydwk.eventmanager.event.events.gateway.ShutDownEvent
    ) {}
    ...
    open fun onSlashCommand(
        event: io.github.ydwk.ydwk.eventmanager.event.events.interaction.SlashCommandEvent
    ) {}
    ...
    open fun onAutoCompleteSlashCommand(
        event:
            io.github.ydwk.ydwk.eventmanager.event.events.interaction.AutoCompleteSlashCommandEvent
    ) {}
     ...
     */
    open fun onModel(event: io.github.ydwk.ydwk.eventmanager.event.events.interaction.ModelEvent) {}
     ...
     */
    open fun onPing(event: io.github.ydwk.ydwk.eventmanager.event.events.interaction.PingEvent) {}
    ...
    open fun onMessageComponent(
        event: io.github.ydwk.ydwk.eventmanager.event.events.interaction.MessageComponentEvent
    ) {}
    ...
    open fun onChannelCreate(
        event: io.github.ydwk.ydwk.eventmanager.event.events.channel.ChannelCreateEvent
    ) {}
    ...
    open fun onChannelDelete(
        event: io.github.ydwk.ydwk.eventmanager.event.events.channel.ChannelDeleteEvent
    ) {}
