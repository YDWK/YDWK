...
import io.github.ydwk.ydwk.entities.guild.GuildScheduledEvent
import io.github.ydwk.ydwk.entities.guild.schedule.EntityMetadata
import io.github.ydwk.ydwk.entities.guild.schedule.EntityType
import io.github.ydwk.ydwk.entities.guild.schedule.PrivacyLevel
import io.github.ydwk.ydwk.entities.guild.schedule.ScheduledEventStatus
import io.github.ydwk.ydwk.impl.entities.UserImpl
import io.github.ydwk.ydwk.impl.entities.guild.schedule.EntityMetadataImpl
...
class GuildScheduledEventImpl(
    ...
    override val channel: GuildChannel?
        get() =
            if (json.has("channel_id")) ydwk.getGuildChannelById(json["channel_id"].asText())
            else null

    override val creator: User?
        get() = if (json.has("creator")) ydwk.getUserById(json["creator"]["id"].asText()) else null
    ...
    override val entityMetadata: EntityMetadata?
        get() =
            if (json.hasNonNull("entity_metadata"))
                EntityMetadataImpl(ydwk, json["entity_metadata"])
            else null
