...
class InteractionImpl(
  ...
  override val applicationId: GetterSnowFlake = GetterSnowFlake.of(json["application_id"].asLong())
  ...
  override val data: GenericCommandData? =
    when (type) {
      InteractionType.APPLICATION_COMMAND -> SlashCommandImpl(ydwk, json["data"], idAsLong, this)
