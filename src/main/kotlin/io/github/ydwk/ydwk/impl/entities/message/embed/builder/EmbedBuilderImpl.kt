 ...
 */ 
package io.github.ydwk.ydwk.impl.entities.message.embed.builder

import com.fasterxml.jackson.databind.JsonNode
import io.github.ydwk.ydwk.YDWK
import io.github.ydwk.ydwk.entities.message.Embed
import io.github.ydwk.ydwk.entities.message.embed.builder.*
import io.github.ydwk.ydwk.impl.entities.message.EmbedImpl
import io.github.ydwk.ydwk.util.Checks
import io.github.ydwk.ydwk.util.toOffsetDateTime
import java.awt.Color
import java.net.URL
import java.time.OffsetDateTime
import java.time.temporal.TemporalAccessor

class EmbedBuilderImpl(private val ydwk: YDWK) : EmbedBuilder {
  ...
  override fun setDescription(description: CharSequence): EmbedBuilder {
    Checks.checkLength(description, 4096, "Embed description needs to be 4096 characters or less")
  ...
  override fun build(): Embed {
    val json = ydwk.objectNode
    val thumbnailJson = ydwk.objectNode
    val imageJson = ydwk.objectNode
    val authorJson = ydwk.objectNode
    val footerJson = ydwk.objectNode
    ...
    when {
      ...
      image != null -> {
        ...
        if (image!!.proxyUrl != null) imageJson.put("proxy_url", image!!.proxyUrl.toString())
