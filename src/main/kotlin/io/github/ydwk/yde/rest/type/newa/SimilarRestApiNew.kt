...
interface SimilarRestApiNew {
    fun header(name: String, value: String): SimilarRestApiNew

    fun addHeader(name: String, value: String): SimilarRestApiNew

    fun removeHeader(name: String): SimilarRestApiNew

    fun headers(headers: Headers): SimilarRestApiNew

    fun addReason(reason: String?): SimilarRestApiNew
