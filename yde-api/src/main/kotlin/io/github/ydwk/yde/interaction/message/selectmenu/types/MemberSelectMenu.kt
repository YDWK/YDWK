...
import io.github.ydwk.yde.interaction.message.selectmenu.creator.builder.types.MemberSelectMenuCreatorBuilder
...
interface MemberSelectMenu : SelectMenu {
    ...
    companion object {
        ...
        operator fun invoke(
            ...
            return MemberSelectMenuCreatorBuilder(customId)
        }
    }
}
