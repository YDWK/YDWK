...
import io.github.ydwk.yde.interaction.message.selectmenu.creator.builder.types.RoleSelectMenuCreatorBuilder
...
interface RoleSelectMenu : SelectMenu {
    ...
    companion object {
        ...
        operator fun invoke(customId: String): RoleSelectMenuCreator {
            return RoleSelectMenuCreatorBuilder(customId)
        }
    }
}
