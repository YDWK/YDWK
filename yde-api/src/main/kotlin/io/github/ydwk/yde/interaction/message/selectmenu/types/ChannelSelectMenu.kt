...
import io.github.ydwk.yde.interaction.message.selectmenu.creator.builder.types.ChannelSelectMenuCreatorBuilder
...
interface ChannelSelectMenu : SelectMenu {
    ...
    companion object {
        ...
        operator fun invoke(
            ...
            return ChannelSelectMenuCreatorBuilder(customId, channelTypes)
        }
    }
}
