...
import io.github.ydwk.yde.interaction.message.selectmenu.creator.builder.types.UserSelectMenuCreatorBuilder
...
interface UserSelectMenu : SelectMenu {
    ...
    companion object {
        ...
        operator fun invoke(customId: String): UserSelectMenuCreator {
            return UserSelectMenuCreatorBuilder(customId)
        }
    }
}
