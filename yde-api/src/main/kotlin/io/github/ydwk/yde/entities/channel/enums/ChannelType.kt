...
enum class ChannelType(private val id: Int) {
  ...
  /**
   * A temporary sub-channel within a GUILD_TEXT channel that is only viewable by those invited and
   * those with the MANAGE_THREADS permission.
   */
  PRIVATE_THREAD(12),
  ...
  companion object {
     ...
     */
    fun getValue(id: Int): ChannelType {
