...
interface SelectMenu : Component {
  ...
  /**
   * The list of default values for auto-populated select menu components; number of default values
   * must be in the range defined by min_values and max_values.
   *
   * @return the list of default values for auto-populated select menu components; number of default
  ...
  companion object {
     ...
     */
    fun createMemberSelectMenu(yde: YDE, customId: String): MemberSelectMenuCreator {
     ...
     */
    fun createRoleSelectMenu(yde: YDE, customId: String): RoleSelectMenuCreator {
     ...
     */
    fun createUserSelectMenu(yde: YDE, customId: String): UserSelectMenuCreator {
