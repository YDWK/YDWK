...
/**
 * This event is triggered when a scheduled event is created.
 *
 * @param ydwk The [YDWK] instance.
 * @param scheduledEvent The [GuildScheduledEvent] that was created.
 */
@GuildEvent
data class GuildScheduledEventCreateEvent(
