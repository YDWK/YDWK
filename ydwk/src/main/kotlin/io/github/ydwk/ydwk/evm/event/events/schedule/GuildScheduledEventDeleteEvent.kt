...
/**
 * This event is triggered when a scheduled event is deleted.
 *
 * @param ydwk The [YDWK] instance.
 * @param scheduledEvent The [GuildScheduledEvent] that was deleted.
 */
@GuildEvent
data class GuildScheduledEventDeleteEvent(
