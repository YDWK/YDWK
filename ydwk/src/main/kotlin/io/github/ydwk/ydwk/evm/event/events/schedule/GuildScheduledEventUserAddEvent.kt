...
/**
 * This event is triggered when a user subscribes to a scheduled event.
 *
 * @param ydwk The [YDWK] instance.
 * @param scheduledEventId The id of the scheduled event.
 * @param guildId The id of the guild.
 * @param user The [User] that subscribed (null if not cached).
 * @param scheduledEvent The [GuildScheduledEvent] (null if not cached).
 */
@GuildEvent
data class GuildScheduledEventUserAddEvent(
