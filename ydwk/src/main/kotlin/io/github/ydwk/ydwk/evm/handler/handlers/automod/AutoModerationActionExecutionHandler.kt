...
class AutoModerationActionExecutionHandler(ydwk: YDWKImpl, json: JsonNode) : Handler(ydwk, json) {
  override suspend fun start() {
    ...
    val ruleTriggerType = AutoModerationTriggerType.fromValue(json["rule_trigger_type"].asInt())
